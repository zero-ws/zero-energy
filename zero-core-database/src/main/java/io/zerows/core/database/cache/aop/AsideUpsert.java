...
*/
     ...
     * upsert(id, Tool)
     */
    @Around(value = "execution(* io.zerows.core.database.jooq.operation.UxJooq.upsert(Object,T))")
     ...
     * upsertAsync(id, Tool)
     */
    @Around(value = "execution(* io.zerows.core.database.jooq.operation.UxJooq.upsertAsync(Object,T))")
     ...
     */
    @Around(value = "execution(* io.zerows.core.database.jooq.operation.UxJooq.upsert(io.vertx.core.json.JsonObject, T))")
     ...
     */
    @Around(value = "execution(* io.zerows.core.database.jooq.operation.UxJooq.upsertAsync(io.vertx.core.json.JsonObject, T))")
     ...
     * upsert(JsonObject, Tool)
     */
    @Around(value = "execution(* io.zerows.core.database.jooq.operation.UxJooq.upsert(io.vertx.core.json.JsonObject, T, String))")
     ...
     * upsertAsync(JsonObject, Tool)
     */
    @Around(value = "execution(* io.zerows.core.database.jooq.operation.UxJooq.upsertAsync(io.vertx.core.json.JsonObject, T, String))")
     ...
     */
    @Around(value = "execution(* io.zerows.core.database.jooq.operation.UxJooq.upsert(io.vertx.core.json.JsonObject, java.util.List, java.util.function.BiPredicate))")
     ...
     */
    @Around(value = "execution(* io.zerows.core.database.jooq.operation.UxJooq.upsertAsync(io.vertx.core.json.JsonObject, java.util.List, java.util.function.BiPredicate))")
     ...
     */
    @Around(value = "execution(* io.zerows.core.database.jooq.operation.UxJooq.upsert(io.vertx.core.json.JsonObject, java.util.List, java.util.function.BiPredicate, String))")
     ...
     */
    @Around(value = "execution(* io.zerows.core.database.jooq.operation.UxJooq.upsertAsync(io.vertx.core.json.JsonObject, java.util.List, java.util.function.BiPredicate, String))")
