...
/*    @Before(value = "initialization(io.vertx.up.operation.jooq.UxJooq.new(..)) && args(clazz,dao)", argNames = "clazz,dao")
     ...
     * deleteByIdAsync
     */
    @Around(value = "execution(* io.zerows.core.database.jooq.operation.UxJooq.deleteById*(..)) && args(id)", argNames = "id")
     ...
     * deleteBy
     */
    @Around(value = "execution(* io.zerows.core.database.jooq.operation.UxJooq.deleteBy(..))")
     ...
     * deleteByAsync
     */
    @Around(value = "execution(* io.zerows.core.database.jooq.operation.UxJooq.deleteByAsync(..))")
     ...
     * delete(Tool)
     */
    @Around(value = "execution(* io.zerows.core.database.jooq.operation.UxJooq.delete(T))")
     ...
     * delete(List<Tool>)
     */
    @Around(value = "execution(* io.zerows.core.database.jooq.operation.UxJooq.delete(java.util.List))")
     ...
     * deleteAsync(Tool)
     */
    @Around(value = "execution(* io.zerows.core.database.jooq.operation.UxJooq.deleteAsync(T))")
     ...
     * deleteAsync(List<Tool>)
     */
    @Around(value = "execution(* io.zerows.core.database.jooq.operation.UxJooq.deleteAsync(java.util.List))")
