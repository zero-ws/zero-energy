...
/*    @Before(value = "initialization(io.vertx.up.operation.jooq.UxJooq.new(..)) && args(clazz,dao)", argNames = "clazz,dao")
     ...
     * fetch
     */
    @Around(value = "execution(* io.zerows.core.database.jooq.operation.UxJooq.fetch(..))")
     ...
     * fetchAsync
     */
    @Around(value = "execution(* io.zerows.core.database.jooq.operation.UxJooq.fetchAsync(..))")
     ...
     * fetchByIdAsync
     */
    @Around(value = "execution(* io.zerows.core.database.jooq.operation.UxJooq.fetchById*(..)) && args(id)", argNames = "id")
     ...
     */
    @Around(value = "execution(* io.zerows.core.database.jooq.operation.UxJooq.fetchOne*(..))")
