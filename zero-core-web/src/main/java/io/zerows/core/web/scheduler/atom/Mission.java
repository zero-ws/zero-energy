package io.zerows.core.web.scheduler.atom;
...
import io.zerows.core.web.scheduler.exception._409JobFormulaErrorException;
import io.zerows.core.web.scheduler.exception._501JobOnMissingException;
    ...
    public Mission connect(final Class<?> clazz) {
        ...
        if (Objects.nonNull(proxy)) {
            ...
            if (DevEnv.devJobBoot()) {
                LOGGER.info(MessageOfJob.MISSION.JOB_OFF, this.getCode());
            }
        }
        return this;
    }
