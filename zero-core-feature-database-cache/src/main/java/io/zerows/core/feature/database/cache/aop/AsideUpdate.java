...
/*    @Before(value = "initialization(io.vertx.up.operation.jooq.UxJooq.new(..)) && args(clazz,dao)", argNames = "clazz,dao")
     ...
     * update(Tool)
     */
    @Around(value = "execution(* io.zerows.core.feature.database.jooq.operation.UxJooq.update(T))")
     ...
     * updateAsync(Tool)
     */
    @Around(value = "execution(* io.zerows.core.feature.database.jooq.operation.UxJooq.updateAsync(T))")
     ...
     * update(List<Tool>)
     */
    @Around(value = "execution(* io.zerows.core.feature.database.jooq.operation.UxJooq.update(java.util.List))")
     ...
     * updateAsync(List<Tool>)
     */
    @Around(value = "execution(* io.zerows.core.feature.database.jooq.operation.UxJooq.updateAsync(java.util.List))")
     ...
     * update(id, Tool)
     */
    @Around(value = "execution(* io.zerows.core.feature.database.jooq.operation.UxJooq.update(Object, T))")
     ...
     * updateAsync(id, Tool)
     */
    @Around(value = "execution(* io.zerows.core.feature.database.jooq.operation.UxJooq.updateAsync(Object, T))")
     ...
     */
    @Around(value = "execution(* io.zerows.core.feature.database.jooq.operation.UxJooq.update(io.vertx.core.json.JsonObject, T))")
     ...
     */
    @Around(value = "execution(* io.zerows.core.feature.database.jooq.operation.UxJooq.updateAsync(io.vertx.core.json.JsonObject, T))")
     ...
     */
    @Around(value = "execution(* io.zerows.core.feature.database.jooq.operation.UxJooq.update(io.vertx.core.json.JsonObject, T, String))")
     ...
     */
    @Around(value = "execution(* io.zerows.core.feature.database.jooq.operation.UxJooq.updateAsync(io.vertx.core.json.JsonObject, T, String))")
