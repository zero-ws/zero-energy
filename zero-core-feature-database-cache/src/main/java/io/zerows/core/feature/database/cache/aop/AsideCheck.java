...
public class AsideCheck extends L1AsideReading {
     ...
     * existById
     */
    @Around(value = "execution(* io.zerows.core.feature.database.jooq.operation.UxJooq.existById(..)) && args(id)", argNames = "id")
     ...
     * existByIdAsync
     */
    @Around(value = "execution(* io.zerows.core.feature.database.jooq.operation.UxJooq.existByIdAsync(..)) && args(id)", argNames = "id")
     ...
     * exist
     */
    @Around(value = "execution(* io.zerows.core.feature.database.jooq.operation.UxJooq.exist(..))")
    ...
    @Around(value = "execution(* io.zerows.core.feature.database.jooq.operation.UxJooq.existAsync(..))")
