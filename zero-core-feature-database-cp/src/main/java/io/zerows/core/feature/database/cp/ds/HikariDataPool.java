package io.zerows.core.feature.database.cp.ds;
...
public class HikariDataPool implements DataPool {
    ...
    private static final String OPT_KEEP_ALIVE_TIME = "hikari.keep.alive.time";
    ...
    public HikariDataPool(final KDatabase database) {
    ...
    private void initJooq() {
        if (null == this.context) {
            ...
            final SQLDialect dialect = DSMeta.DIALECT.get(this.database.getCategory());
