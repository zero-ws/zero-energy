package io.zerows.core.feature.web.mbse.atom.shape;
...
public abstract class AbstractHAtom implements HAtom {
    ...
    private static final Cc<Integer, io.zerows.core.feature.web.mbse.atom.shape.HAtomRule> CC_RULE = Cc.open();
    private static final Cc<Integer, HAtomMetadata> CC_METADATA = Cc.open();

    protected final String unique;

    protected transient final io.zerows.core.feature.web.mbse.atom.shape.HAtomRule ruler;
    ...
    public AbstractHAtom(final HModel model) {
        ...
        this.ruler = CC_RULE.pick(() -> new io.zerows.core.feature.web.mbse.atom.shape.HAtomRule(model), modelCode);
