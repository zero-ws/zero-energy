...
public class Verifier {
    ...
    public static void verify(final Event event) {
        ...
        Fn.outBoot(null == method, LOGGER, BootEventActionNoneException.class,
    ...
    public static void verify(final Method method, final Class<? extends Annotation> annoCls) {
        ...
        Fn.outBoot(1 < occurs, LOGGER, BootAnnotationRepeatException.class,
    ...
    public static void verify(final Parameter parameter) {
        ...
        Fn.outBoot(1 < multi, LOGGER, BootParamAnnotationException.class,
