...
class _Bundle extends _Ai {
    ...
    public static class Bnd {
         ...
         *        );
         *     3. 旧版：
         *        return Fn.outWeb(_400SigmaMissingException.class, HHotel.class);
         * </code></pre>
         * 注：这两个方法的区别
         * <pre><code>
         *     1. {@see Fn#outWeb(Class, Object...)}()}，此方法不支持 OSGI 环境，旧版异步流中只有一个方法返回了 Future，基于此
