...
import io.zerows.core.feature.database.cache.util.CacheAside;
...
public class L1Aside {
     ...
     * -- read
     *    readAsync
     * Read information such as Tool & List<Tool> returned from cache here
     */
     ...
     * -- exist
     *    existAsync
     * Exist such as Tool & List<Tool>, the different point is returned type is Boolean
     */
