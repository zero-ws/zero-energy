...
import io.zerows.core.metadata.uca.execution.ServiceRunner;
...
public class CallbackOfService implements OCallback.Standard {
     ...
     *         Zero.Core.Runtime.Metadata / Zero.Core.Runtime.Metadata
     *     2. {@link EnergyService}
     *         Zero.Core.Runtime.Metadata / Zero.Core.Runtime.Metadata
     *     3. {@link EnergyConfiguration}
     *         Zero.Core.Runtime.Metadata / Zero.Core.Web.Model
     *     4. {@link EnergyDeployment}
     *         Zero.Core.Runtime.Metadata / Zero.Core.Web.Container
     *     其他可用服务
     *     5. {@see EnergyVertx}
    ...
    public void stop(final Object reference) {
        // Fix Error: ERROR: [FelixStartLevel] "stop" callback not found on component instances [io.zerows.core.metadata.osgi.dependency.CallbackOfService@465e9b70]
        final ServiceContext context = this.parameter.context();
        // 服务执行专用流程
