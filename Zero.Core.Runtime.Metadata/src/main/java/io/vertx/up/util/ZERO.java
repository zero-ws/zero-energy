 ...
 * E       day-of-week                 text              Tue; Tuesday; Tool
 * e/c     localized day-of-week       number/text       2; 02; Tue; Tuesday; Tool
...
interface Iso {
     ...
     * yyyy-MM-dd'Tool'HH:mm:ss.SSS'Z' 常用时间格式解析
     */
    DateTimeFormatter COMMON = DateTimeFormatter.ofPattern("yyyy-MM-dd'Tool'HH:mm:ss.SSS'Z'")
        .withLocale(Locale.getDefault());
    /**
     * 2017-02-03 20:10:11
     */
