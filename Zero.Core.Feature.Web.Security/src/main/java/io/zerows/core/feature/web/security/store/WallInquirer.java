...
import io.zerows.core.feature.web.security.exception.BootWallDuplicatedException;
import io.zerows.core.feature.web.security.exception.BootWallKeyMissingException;
import io.zerows.core.feature.web.security.exception.BootWallMethodDuplicatedException;
import io.zerows.core.feature.web.security.exception.BootWallTypeWrongException;
...
public class WallInquirer implements Inquirer<Set<Aegis>> {
    ...
    private void verifyConfig(final Class<?> clazz, final Aegis reference, final String typeKey) {
        ...
        /* Wall Type Wrong */
        Fn.outBoot(Objects.isNull(wall), LOGGER, BootWallTypeWrongException.class,
        ...
        if (EmSecure.AuthWall.EXTENSION == wall) {
            ...
            Fn.outBoot(Objects.isNull(found), LOGGER, BootWallKeyMissingException.class,
