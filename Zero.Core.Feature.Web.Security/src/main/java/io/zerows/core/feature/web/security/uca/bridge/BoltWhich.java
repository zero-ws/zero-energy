...
import io.zerows.core.feature.web.security.exception.BootWallProviderConflictException;
import io.zerows.core.feature.web.security.exception.BootWallSizeException;
...
class BoltWhich implements Bolt {
    ...
    private Aegis verifyAuthenticate(final Aegis config) {
        if (EmSecure.AuthWall.EXTENSION != config.getType()) {
            ...
            Fn.outBoot(Objects.isNull(item), BootWallSizeException.class,
